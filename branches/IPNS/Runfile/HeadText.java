...
*/
public HeadText() { 
JTextArea headTextArea = new JTextArea();
...
/**
This constructor will create the text area filled with the run file header 
information.
...
Font font;
   ...
   headTextArea.append( "Version Number:          " + runFile.VersionNumber() 
			+ "\n" );
   headTextArea.append( "Number Of Detectors:     " + runFile.NumDet() + "\n" );
   headTextArea.append( "User Name:               " + runFile.UserName() + "\n");
   ...
   headTextArea.append( "Protection Status:       " + runFile.ProtectionStatus()
			+ "\n" );
   headTextArea.append( "Variable To Monitor:    " + runFile.VarToMonitor() 
			+ "\n" );
   ...
   headTextArea.append( "Preset Cycles:          " + runFile.NumOfCyclesPreset()
			+ "\n" );
   headTextArea.append( "Elapsed Cycled:         " 
			+ runFile.NumOfCyclesCompleted() + "\n" );
   headTextArea.append( "Run After Finished:     " + runFile.RunAfterFinished() 
			+ "\n" );
   headTextArea.append( "Total Monitor Counts:   " + runFile.TotalMonitorCounts()
			+ "\n" );
   headTextArea.append( "Detector Calib File:    " + runFile.DetectorCalibFile()
			+ "\n" );
   headTextArea.append( "DetLocUnit:             " + runFile.DetLocUnit()
			+ "\n" );
   headTextArea.append( "Pseudo Time Unit:       " + runFile.PseudoTimeUnit()
			+ "\n" );
   ...
   headTextArea.append( "Moderator Calib File:   " + runFile.ModeratorCalibFile()
			+ "\n" );
   headTextArea.append( "Group to monitor:       " + runFile.GroupToMonitor()
			+ "\n");
   headTextArea.append( "Channel to Monitor:     " + runFile.ChannelToMonitor()
			+ "\n");
