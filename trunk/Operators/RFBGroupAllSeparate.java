 ...
 *
 *  $Log$
 *  Revision 1.2  2002/02/23 14:00:12  hammonds
...
public class RFBGroupAllSeparate extends  GenericBatch 
                            implements Serializable
{

  /* ------------------------ FULL CONSTRUCTOR -------------------------- */
  /**
   * Construct a default RFBGroupAllSeparate operator to to allow scripts to call IPNS.RunfileBuilder.
   */
  public RFBGroupAllSeparate( RunfileBuilder rfb, Integer val1, Integer val2)
  {
	
    super( "RFBGroupAllSeparate" );
...
public RFBGroupAllSeparate()
  ...
  */
  ...
  public Object getResult()
  {
    ...
    rval = rfb.groupAllSeparate(val1, val2);    
