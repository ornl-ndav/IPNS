 ...
 *  Cleanup imports.
 *
 *  Revision 1.4  2002/02/23 13:59:46  hammonds
...
public class RFBAddNormalTF extends  GenericBatch 
                            implements Serializable
{

  /* ------------------------ FULL CONSTRUCTOR -------------------------- */
  /**
   * Construct a default RFBAddNormalTF operator to to allow scripts to call IPNS.RunfileBuilder.
   */
  public RFBAddNormalTF( RunfileBuilder rfb, Float val1, Float val2, Float val3, Integer val4)
  {
...
//	System.out.println("def constructor");
  ...
  */
  ...
  public Object getResult()
  {
    ...
    rval = rfb.addNormalTimeField(val1, val2, val3, val4);    
