...
public class ParameterFile {
  ...
  */
  public void printDevice() {
    System.out.println(this.getPrintDevice());
  }
  ...
  */
  public void printDeviceBrief() {
    System.out.println( this.getPrintDeviceBrief());
  }
  ...
  */
  public String getPrintDevice() {
    ...
    temp.append( deviceNameDbSignal + "\n");
    temp.append( controllerName + "\n");
    temp.append( dbDevice + "\n");
    temp.append( ancIoc + "\n");
    temp.append( vetoSignal + "\n");
  ...
  /**
     Prints information on the device and its controller
  */
  public String getPrintDeviceBrief() {
    return( deviceName + " uses " + controllerName);
  }
  ...
  */
  ...
  public void printUserParameters() {
    System.out.println(this.getPrintUserParameters());
  }

  /**
   */
  public void printUserParametersBrief() {
    System.out.println(this.getPrintUserParametersBrief());
  }

  /**
   */
  public void printInstParameters() {
    System.out.println(this.getPrintInstParameters());
  }

  /**
   */
  public void printInstParametersBrief() {
    System.out.println(this.getPrintInstParametersBrief());
  }

  public String getPrintUserParameters() {
    StringBuffer temp = new StringBuffer();
    temp.append("User Parameters" + "\n");
    temp.append(Parameter.getPrintParameters( userParameter ));
    return temp.toString();
  }

  /**
   */
  public String getPrintUserParametersBrief() {
    StringBuffer temp = new StringBuffer();
    temp.append("User Parameters" + "\n");
    temp.append(Parameter.getPrintParametersBrief( userParameter ));
    return temp.toString();
  }

  /**
   */
  public String getPrintInstParameters() {
    StringBuffer temp = new StringBuffer();
    temp.append("Inst Parameters" + "\n" );
    temp.append(Parameter.getPrintParameters( instParameter ));
    return temp.toString();
  }

  /**
   */
  public String getPrintInstParametersBrief() {
    StringBuffer temp = new StringBuffer();
    temp.append("Inst Parameters" + "\n");
    temp.append(Parameter.getPrintParametersBrief( instParameter ));
    return temp.toString();
  }
