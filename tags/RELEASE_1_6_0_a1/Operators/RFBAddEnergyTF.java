 ...
 *  Cleanup imports.
 *
 *  Revision 1.3  2002/02/23 13:51:11  hammonds
...
public class RFBAddEnergyTF extends  GenericBatch 
                            implements Serializable
{

  /* ------------------------ FULL CONSTRUCTOR -------------------------- */
  /**
   * Construct a default RFBAddEnergyTF operator to to allow scripts to call IPNS.RunfileBuilder.
   */
  public RFBAddEnergyTF( RunfileBuilder rfb, Float val1, Float val2, Float val3, Integer val4)
  {
	
    super( "RFBAddEnergyTF" );
...
public RFBAddEnergyTF()
  ...
  */
  ...
  public Object getResult()
  {
    ...
    rval = rfb.addEnergyTimeField(val1, val2, val3, val4);    
